...
const TextAndMediaAdForm = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.landscapeimageURL.trim() === "") {
      errors.landscapeimageURL = "Landscape marketting image URL is required";
    }

    if (formData.portraitimageURL.trim() === "") {
      errors.portraitimageURL = "Portrait marketting image URL is required";
    }

    if (formData.squareimageURL.trim() === "") {
      errors.squareimageURL = "Square marketting image URL is required";
    }
  ...
  return (
    <>
      {message.alert && <Modals text={message.alert} show={message.show} handleClose={handleCloseModal} />}
        ...
        <Form onSubmit={handleSubmit} className={style.main_container} >
          ...
          <Form.Group className="row">
            <Form.Group className="col-md-4">
              <Form.Group className="mb-3 mr-2">
                <Form.Label >Landscape Marketing Image (1.9:1)<small>*{formErrors && formErrors.landscapeimageURL}</small></Form.Label>
                <Form.Control
                  type="text"
                  placeholder="Add the URL of the image you want to use for the ad"
                  name="landscapeimageURL"
                  value={formData.landscapeimageURL}
                  onChange={handleChange}
                />
              </Form.Group>
            </Form.Group>
            <Form.Group className="col-md-4">
              <Form.Group className="mb-3 mr-2">
                <Form.Label >Portrait Marketing Image (4:5)<small>*{formErrors && formErrors.portraitimageURL}</small></Form.Label>
                <Form.Control
                  type="text"
                  placeholder="Add the URL of the image you want to use for the ad"
            ...
            <Form.Group className="col-md-4">
              <Form.Group className="mb-3 mr-2">
                <Form.Label >Square Marketing Image (1:1)<small>*{formErrors && formErrors.squareimageURL}</small></Form.Label>
                <Form.Control
                  type="text"
                  placeholder="Add the URL of the image you want to use for the ad"
                  name="squareimageURL"
                  value={formData.squareimageURL}
                  onChange={handleChange}
                />
              </Form.Group>
            </Form.Group>
          ...
          <Form.Group className="row">
            <Form.Group className="col-md-12">
              <Form.Group className="mb-3 mr-2">
                <Form.Label >Video URL<small>*{formErrors && formErrors.videoURL}</small></Form.Label>
                <Form.Control
                  type="text"
...
export default TextAndMediaAdForm;